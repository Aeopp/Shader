...
// Emboss
//--------------------------------------------------------------//
string Emboss_Emboss_ScreenAlignedQuad : ModelData = "C:\\Program Files (x86)\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\ScreenAlignedQuad.3ds";
...
VS_OUTPUT Emboss_Emboss_Vertex_Shader_vs_main( VS_INPUT Input )
{
   VS_OUTPUT Output;
...
float4 Emboss_Emboss_Pixel_Shader_ps_main(PS_INPUT Input):COLOR 
{
   float res=0;
   for(int y=-1; y<=1; ++y)
   {
