...
// Pass 0
//--------------------------------------------------------------//
string ToonShader_Pass_0_Model : ModelData = "..\\..\\source\\06_ToonShader\\teapot.x";
...
float4 ToonShader_Pass_0_Pixel_Shader_gWorldLightPosition;
...
{  
   float3 LightDir = Input.mPosition - ToonShader_Pass_0_Pixel_Shader_gWorldLightPosition.xyz;
